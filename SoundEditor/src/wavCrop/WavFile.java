...
class WavFile
{
    ...
    public static WavFile readFromFilePath(String filePathToReadFrom,int startPoint, int stopPoint)
    {        
    	start = startPoint;
    	stop = stopPoint;
        ...
        throws IOException
    {
		...
		System.out.println("Sample Per Sec"+samplesPerSecond);
        int bytesPerSecond = reader.readInt();
		BPS= bytesPerSecond;
		System.out.println("BytespSec"+bytesPerSecond);
        ...
        throws IOException
    {
		...
		//int subchunk2Size1 = (subchunk2Size - ((subchunk2Size/BPS) - 7));
		int subchunk2Size1 = BPS * (stop-start);
		System.out.println("subchunk2Size1"+subchunk2Size);
		//System.out.println("BPS"+BPS);

        byte[] samplesForChannelsMixedAsBytes1 = new byte[subchunk2Size];
        reader.read(samplesForChannelsMixedAsBytes1 );
		
		byte[] samplesForChannelsMixedAsBytes = new byte[subchunk2Size1];
		
		samplesForChannelsMixedAsBytes = Arrays.copyOfRange(samplesForChannelsMixedAsBytes1, (start*BPS), (stop*BPS));
		
		//samplesForChannelsMixedAsBytes = samplesForChannelsMixedAsBytes1;
        ...
        throws IOException
    {
		...
		System.out.println("numberOfBytesInSamples="+numberOfBytesInSamples);
